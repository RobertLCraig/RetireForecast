...
{
    public static function build(AssistantContext $context, bool $adviceAllowed, string $methodology = ''): string
    {
        $rules = [
            'You are a careful explainer for a UK retirement-forecasting tool. '.$context->systemIntro(),
