{{-- The three hero time-series charts (C1 income staircase, C2 wealth composition, C3 costs
     ...
     accessible source of truth; the canvas is a progressive enhancement). Figures are in
     today's money, like the ladder and fan. --}}
<section id="sec-money-over-time" aria-labelledby="money-over-time-heading" class="{{ $card }} scroll-mt-6 space-y-8">
    <div>
        ...
        <p class="mt-1 text-sm text-gray-600">
            The same year-by-year figures as the cashflow table below, drawn as pictures: where your income comes from, where your wealth sits, and how your spending changes as you age. All figures are in today's money, and follow the central best-estimate projection (one illustrative path, not a probability). The dashed verticals mark the life events that drive each step change.
        </p>
    </div>
    ...
    <div>
        ...
        <div class="mt-4" wire:key="ts-income-{{ $ladderSelected }}">
            <div wire:ignore>
        ...
        <details class="mt-3">
            ...
            <div class="mt-2 overflow-x-auto" tabindex="0">
                <table class="w-full text-sm whitespace-nowrap">
                    <caption class="sr-only">Income by source (real pounds) by calendar year for {{ $ladderSelectedLabel }}</caption>
                    <thead>
                        <tr>
    ...
    <div>
        ...
        <div class="mt-4" wire:key="ts-wealth-{{ $ladderSelected }}">
            <div wire:ignore>
        ...
        <details class="mt-3">
            ...
            <div class="mt-2 overflow-x-auto" tabindex="0">
                <table class="w-full text-sm whitespace-nowrap">
                    <caption class="sr-only">Wealth by type (real pounds) by calendar year for {{ $ladderSelectedLabel }}</caption>
                    <thead>
                        <tr>
                            <th scope="col" class="{{ $th }}">Year</th>
                            <th scope="col" class="{{ $th }}">Age(s)</th>
    ...
    <div>
        ...
        <div class="mt-4" wire:key="ts-costs-{{ $ladderSelected }}">
            <div wire:ignore>
        ...
        <details class="mt-3">
            ...
            <div class="mt-2 overflow-x-auto" tabindex="0">
                <table class="w-full text-sm whitespace-nowrap">
                    <caption class="sr-only">Spending split into essential and discretionary (real pounds) by calendar year for {{ $ladderSelectedLabel }}</caption>
                    <thead>
                        <tr>
                            <th scope="col" class="{{ $th }}">Year</th>
                            <th scope="col" class="{{ $th }}">Age(s)</th>
