...
final class BuilderStateFixture
{
    ...
    public static function full(): array
    {
        return [
            ...
            'oneOffCosts' => [['atAge' => '80', 'amount' => '45000', 'label' => 'Care top-up']],
            'pensions' => [
                ['ownerId' => 'p1', 'subtype' => 'dc', 'currentValue' => '410000', 'ongoingContribution' => '8000',
                    'employerContribution' => '4000', 'earliestAccessAge' => '57', 'pclsTakenToDate' => '0',
                    'growthAssumptionOverride' => '4.5', 'withdrawals' => [
                        ['kind' => 'pcls', 'amount' => '100000', 'atAge' => '66'],
                        ['kind' => 'ufpls', 'amount' => '20000', 'atAge' => '67'],
                        ['kind' => 'drawdown', 'amount' => '15000', 'atAge' => '68'],
                    ]],
                ['ownerId' => 'p2', 'subtype' => 'db', 'accruedAnnualPension' => '9200', 'normalRetirementAge' => '65',
                ...
                ['ownerId' => 'p1', 'subtype' => 'state', 'weeklyForecast' => '230.25', 'qualifyingYears' => '', 'deferralWeeks' => '0'],
                ['ownerId' => 'p2', 'subtype' => 'state', 'weeklyForecast' => '', 'qualifyingYears' => '34', 'deferralWeeks' => '8'],
            ],
            'accounts' => [
                ['ownerId' => 'p1', 'type' => 'isa', 'balance' => '85000', 'unrealisedGain' => '', 'yield' => '3'],
                ['ownerId' => 'p2', 'type' => 'gia', 'balance' => '40000', 'unrealisedGain' => '6500', 'yield' => '2'],
                ['ownerId' => 'p1', 'type' => 'cash', 'balance' => '20000', 'unrealisedGain' => '', 'yield' => ''],
            ],
            'incomeStreams' => [
                ['ownerId' => 'p2', 'type' => 'rental', 'grossAnnual' => '7200', 'taxable' => true,
