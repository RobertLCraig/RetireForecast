...
_Last updated: 2026-07-01 (Lane A built **v2 annuitisation**; Lane B shipped the estate-inheritance fix + V2 review polish. Remaining Lane A: stress-test (gated on sourced data), ONS-refresh, care-cost. Feature work pending Rob's browser sign-off. **⚠️ Concurrent sessions may be live (lanes A/B/C/D) — read the next section before you commit.** Narrative in the session log; details in Current state.)_
