...
| docs/PLAN-decision-support.md | Staged plan for the "lever thresholds + combination comparison" feature. **Phases 0–4 BUILT** (Phase 0 spine 2026-07-04; Phases 1–3 + the Phase-4 survivor-cliff story + the full 5-lever menu — DB / annuity / per-person longevity 2026-07-05; defer-the-survivor's-SP on a deferral correctness fix + care-on/off pinned 2026-07-06). Q2 (family-money × PC) + Q3 (target) resolved. **Remaining:** Phase 5 (2-D frontier) + Phase 6 (assistant tie-in). Hardened by a 4-agent review. |
