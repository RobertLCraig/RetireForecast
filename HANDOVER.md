...
**built + refined its Phase 1** (a grounded, local scenario-explainer that interrogates the year-by-year figures,
as a side panel; docs/RESEARCH-local-assistant.md).
