...
**Still to build:** **Phase D go-live polish** — a11y CI (axe/Pa11y), PDF export,
...
Carlo perf item is DONE, and the CSP/security-headers item is DONE (suite 340 green).
What remains in Tier-2: a11y CI (axe/Pa11y), PDF export, 2FA enrolment UI.** Items 1–6 below are kept only to record that they
...
**Independent of the rebuild (Phase 2 step 5 + go-live):** a11y CI (axe/Pa11y), PDF export, 2FA UI
(✅ demo preset/seeder DONE 2026-06-28; ✅ 10k perf DONE 2026-06-28; ✅ CSP header DONE 2026-06-28;
✅ `User::canAccessPanel()` lockdown DONE 2026-06-27; ✅ gov.uk verification pass DONE 2026-06-27).
See "Readiness gaps" + "Blockers".
...
- **Tier 2 — Phase 5–6:** ✅ **demo preset/seeder DONE (2026-06-28)** (`App\Demo\DemoScenario` +
  ...
  tightening); still open: PDF export, a11y CI (axe/Pa11y), 2FA enrolment UI. Scotland config pack is deliberately
  out of v1.
...
php artisan test                            # everything: expect 340 passed (2808 assertions)
...
is the only snapshot). This session's commits (newest first): **Phase D Tier-2 — security headers / CSP**
(`App\Http\Middleware\SecurityHeaders` + `config/security.php` appended to the `web` group + `SecurityHeadersTest`;
this commit); **Phase D Tier-2 — 10k-path Monte Carlo perf**
