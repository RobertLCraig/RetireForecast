...
.pa11yci.json / .github/workflows/a11y.yml / docs/A11Y.md  # Pa11y CI a11y sweep (scaffolded; not yet run green)
...
is the only snapshot). This session's commits (newest first): **Phase D Tier-2 — PDF export + a11y CI scaffold**
...
this commit); **Phase D Tier-2 — 2FA enrolment UI**
