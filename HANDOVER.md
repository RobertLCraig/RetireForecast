...
_Last updated: 2026-06-30 (adviser-legibility complete; What's next is verification + the post-v1 backlog. Latest build: the **longevity distribution** from the Monte Carlo (first backlog item), after partial-PRR CGT. All pending Rob's browser sign-off.)_
