...
- **Tier 1 — trust (blocks "shown as real"):** ✅ **the gov.uk verification pass is DONE (2026-06-27).** Every
  ...
  remaining Tier-1 item is the **data-layer integrity guardrails** (below). See DECISIONS 2026-06-27.
...
is the only snapshot). This session's commits (newest first): **Phase D — admin-panel lockdown (`is_admin`)**
