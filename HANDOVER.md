...
| docs/PLAN-decision-support.md | Staged plan for the "lever thresholds + combination comparison" feature. **Phases 0–3 BUILT** (Phase 0 spine `packages/finance-engine/src/Sweep/` 2026-07-04; Phase 1 the queued/persisted `ThresholdResult` backend + Phase 2 the "How far can we go?" results panel + Phase 3 the combination-comparison surface, 2026-07-05). Q2 (family-money × PC) + Q3 (target) resolved. **Phases 4–6 remain** (survivor-first lever menu in Phase 4, the 2-D frontier in Phase 5, the assistant tie-in in Phase 6). Hardened by a 4-agent review. |
